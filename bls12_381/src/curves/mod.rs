...
use sp_crypto_ec_utils::elliptic_curves as bls12_381_ops;
...
impl CurveHooks for HostHooks {
    fn bls12_381_multi_miller_loop(
        ...
        let res = bls12_381_ops::bls12_381_multi_miller_loop(g1, g2).unwrap_or_default();
    ...
    fn bls12_381_final_exponentiation(
        ...
        let res = bls12_381_ops::bls12_381_final_exponentiation(target).unwrap_or_default();
        let res = ArkScale::<<Bls12_381 as Pairing>::TargetField>::decode(&mut res.as_slice());
        res.map(|v| v.0).map_err(|_| ())
    }
    ...
    fn bls12_381_msm_g1(
        ...
        let res = bls12_381_ops::bls12_381_msm_g1(bases, scalars).unwrap_or_default();
    ...
    fn bls12_381_msm_g2(
        ...
        let res = bls12_381_ops::bls12_381_msm_g2(bases, scalars).unwrap_or_default();
    ...
    fn bls12_381_mul_projective_g1(
        ...
        let res = bls12_381_ops::bls12_381_mul_projective_g1(base, scalar).unwrap_or_default();
        let res = ArkScaleProjective::<G1Projective>::decode(&mut res.as_slice());
        res.map(|v| v.0).map_err(|_| ())
    }
    ...
    fn bls12_381_mul_projective_g2(
        ...
        let res = bls12_381_ops::bls12_381_mul_projective_g2(base, scalar).unwrap_or_default();
        let res = ArkScaleProjective::<G2Projective>::decode(&mut res.as_slice());
        res.map(|v| v.0).map_err(|_| ())
    }
}
